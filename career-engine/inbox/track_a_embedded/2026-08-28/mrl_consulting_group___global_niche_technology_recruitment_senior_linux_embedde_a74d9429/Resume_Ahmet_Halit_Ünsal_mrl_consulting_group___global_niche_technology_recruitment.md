...
## Executive Summary
Senior Engineering Leader & Chief Embedded Systems Architect with 15+ years professional experience and 8+ years directorship managing cross-functional teams up to 30 engineers. Deep technical mastery in Model-Based Design (MATLAB/Simulink/Stateflow), EV Powertrains (VCU/MCU/Inverters/BMS), PMSM FOC motor control, AUTOSAR, and ISO 26262 ASIL D compliance.

## Tailored Competencies for MRL Consulting Group | Global Niche Technology Recruitment (Senior Linux Embedded Software Engineer / Technical Lead)
* **Core Technical Stack:** Model-Based Design (MBD), MATLAB / Simulink / Stateflow, Physical Modeling & Dynamic Simulation, ISO 26262 (Functional Safety ASIL A-D), ASPICE Level 2/3 Process Implementation, UN R155 / UN R156 Automotive Cybersecurity (CSMS), AUTOSAR Classic (BSW/ASW/RTE), FreeRTOS & RTOS Middleware Architecture, C / C++ Bare-Metal & Low-Level Drivers, EV Powertrains: VCU, MCU, Inverters, OBC, BMS
